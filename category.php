        ...
        <div class="blog-filters-container">
            ...
            <div class="blog-filters-wrapper">
                <div class="blog-filters">
                    <a href="<?php echo esc_url(home_url('/category/')); ?>" class="filter-pill">All</a>
                    <?php
                    ...
                    foreach ($target_categories as $cat_name) {
                        ...
                        if ($category) {
                            ...
                            echo '<a href="' . esc_url(get_category_link($category->term_id)) . '" class="filter-pill' . $active_class . '">' . esc_html($category->name) . '</a>';
                        }
                    }
